<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidationWithDefaultTypeConversionForEnum.aspx.cs"
    Inherits="_Default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:TextBox ID="Name" runat="server" Text="LogicalOperationStack" />
            <entlibvalidation:PropertyProxyValidator ID="PropertyValidatorProxyControl" runat="server"
                SourceTypeName="DomainModel.DomainObject" PropertyName="EnumProperty" ControlToValidate="Name"
