<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidationWithFailingCustomTypeConversion.aspx.cs"
    Inherits="_Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <entlibvalidation:PropertyProxyValidator ID="PropertyValidatorProxyControl" runat="server"
                ...
                SpecificationSource="Attributes" RulesetName="" OnValueConvert="CustomConvert" />
            <br />
