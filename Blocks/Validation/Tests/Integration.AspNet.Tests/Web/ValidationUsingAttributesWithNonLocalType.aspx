<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidationUsingAttributesWithNonLocalType.aspx.cs" Inherits="_Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <entlibvalidation:PropertyProxyValidator ID="PropertyValidatorProxyControl" runat="server"
                SourceTypeName="Microsoft.Practices.EnterpriseLibrary.Validation.Tests.TestClasses.TestObjectWithFailingAttributesOnProperties, Microsoft.Practices.EnterpriseLibrary.Validation.Tests" PropertyName="FailingProperty1" ControlToValidate="Name"
