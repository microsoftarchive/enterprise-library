...
namespace Microsoft.Practices.EnterpriseLibrary.Logging.Database.Configuration {
    ...
    internal class DesignResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to 643 - The name of the stored procedure in the database that creates a new Category in the tables. The default is &apos;AddCategory&apos; and is created by the scripts you can run to create the logging database..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 645 - The name of the Database Instance to use for logging messages, as configured in the Data Access Applicaton Block..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 641 - A logging target listener that sends log messages to a specified database using a database instance configured in the Data Access Application Block..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 649 - The name of the Log Message Formatter to use to format log messages written to the database..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 651 - The fully qualified type name of the Listener..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 653 - The name of the Database Trace Listener..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 657 - The fully qualified type name of the Database Trace Listener..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 659 - The name of the stored procedure in the database that writes log messages into the tables. The default is &apos;WriteLog&apos;, and is created by the scripts you can run to create the logging database..
        /// </summary>
