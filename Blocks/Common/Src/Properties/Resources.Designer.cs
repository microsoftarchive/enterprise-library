...
namespace Microsoft.Practices.EnterpriseLibrary.Common.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The configuration download has failed, error message {0}. See the InnerException for more details..
        /// </summary>
        public static string ConfigurationDownloadFailed {
            get {
                return ResourceManager.GetString("ConfigurationDownloadFailed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The configuration content has an invalid format. The content should be in XAML format and the root element must be a ResourceDictionary. Each entry in the dictionary should correspond to each configuration section..
        /// </summary>
