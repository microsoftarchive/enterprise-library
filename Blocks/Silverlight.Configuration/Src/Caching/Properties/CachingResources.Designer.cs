...
namespace Microsoft.Practices.EnterpriseLibrary.Silverlight.Configuration.Caching.Properties {
    using System;
    ...
    internal class CachingResources {
            ...
            get {
                if (object.ReferenceEquals(resourceMan, null)) {
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("Microsoft.Practices.EnterpriseLibrary.Silverlight.Configuration.Caching.Propertie" +
                            "s.CachingResources", typeof(CachingResources).Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The In-Memory Cache has many properties and methods for accessing the cache that will be familiar to you if you have used the Desktop&apos;s MemoryCache class. It is somewhat similar to the System.Runtime.Caching.MemoryCache class available in the .NET Framework in the Desktop..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Just like the In-Memory Cache, the IsolatedStorage cache has many properties and methods for accessing the cache that will be familiar to you if you have used the desktop&apos;s System.Runtime.Caching.MemoryCache class. All the items are saved in-memory but are also saved to the Isolated Cache of Silverlight at the exact same time, allowing easy reloads of the objects when the application starts..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Maximum size in kilobytes before replacing previous cached items..
        /// </summary>
